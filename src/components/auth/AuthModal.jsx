...
export default function AuthModal({ isOpen, onClose }) {
  ...
  return (
    <div className="auth-backdrop" onClick={onClose}>
      ...
      <div className="auth-modal liquid-glass-container" onClick={e => e.stopPropagation()}>
        {/* Liquid Glass Layers */}
        <div className="liquid-glass-distortion-layer" />
        <div className="liquid-glass-color-layer" style={{ background: 'rgba(255, 255, 255, 0.28)' }} />
        <div className="liquid-glass-sheen-layer" />

        {/* Back / close */}
        <button className="auth-close" onClick={onClose} aria-label="Close" style={{ zIndex: 10 }}>
          ✕
        </button>
